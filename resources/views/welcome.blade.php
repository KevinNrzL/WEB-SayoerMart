...
<body>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-primary mb-4">Tentang Kami</h1>
                    <p class="mb-4">Toko Sayur Kami adalah toko sayur online yang berlokasi di [lokasi toko]. Kami
                        menyediakan berbagai macam sayuran segar dan berkualitas dari petani lokal. Kami berkomitmen
                        untuk menyediakan sayuran yang segar, sehat, dan terjangkau bagi masyarakat Indonesia.</p>
                    <p class="mb-4">
                    <p class="mb-4">
                        Toko Sayur Kami didirikan pada tahun 2022. Tujuan pendirian toko ini adalah untuk menyediakan
                        sayuran segar dan berkualitas bagi masyarakat Indonesia. Sejak awal, kami berkomitmen untuk
                        memberikan pelayanan yang terbaik bagi pelanggan kami.</p>
    ...
    <div class="container-fluid how-to-use bg-primary my-5 py-5">
        <div class="container text-white py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-white mb-3">Kenapa memilih Sayur Mart ? </h1>
                <p>Sayur Mart adalah platform e-commerce yang menawarkan berbagai macam produk segar dengan harga
                    terjangkau, layanan pengiriman yang cepat dan mudah, serta kemudahan dalam pemesanan. Hal ini
                    membuat Sayur Mart menjadi pilihan yang tepat bagi konsumen yang ingin berbelanja produk segar
                    dengan mudah dan nyaman. </p>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-primary mb-3">PRODUK PENJUALAN TERBAIK KAMI</h1>
                <p class="mb-5">"Sayur Mart, pilihan tepat untuk keluarga Indonesia."</p>
            </div>
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="product-item text-center border h-100 p-5">
                        ...
                        <a href="" class="h6 d-inline-block mb-2">Bayam</a>
                        <h5 class="text-primary mb-3">Rp. 3.000/ Ikat</h5>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="product-item text-center border h-100 p-5">
                        ...
                        <a href="" class="h6 d-inline-block mb-2">Kangkung</a>
                        <h5 class="text-primary mb-3">Rp. 5.000/ Ikat</h5>
                        <a href="" class="btn btn-outline-primary px-3">Add To Cart</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="product-item text-center border h-100 p-100">
                        ...
                        <a href="" class="h6 d-inline-block mb-2">Sawi Hijau</a>
                        <h5 class="text-primary mb-3">Rp. 3.000/ Ikat</h5>
                        <a href="" class="btn btn-outline-primary px-3">Add To Cart</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="product-item text-center border h-100 p-5">
                        ...
                        <a href="" class="h6 d-inline-block mb-2">Strawberry</a>
                        <h5 class="text-primary mb-3">Rp. 30.000/250gr</h5>
                        <a href="" class="btn btn-outline-primary px-3">Add To Cart</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid testimonial bg-primary my-5 py-5">
        <div class="container text-white py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-white mb-3">Apa Kata Pelanggan Kami tentang Sayur Mart </h1>
            </div>
